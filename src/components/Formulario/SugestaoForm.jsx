...
const campos = [
  { name: "titulo", label: "Título", placeholder: "Título da sugestão" },
  { name: "descricao", label: "Descrição", placeholder: "Descreva a sugestão", type: "textarea" },
...
function SugestaoForm() {
  ...
  return (
    <Formulario
      titulo="Fazer uma Sugestão"
      campos={campos}
      schema={schema}
      onSubmitAction={handleSubmit}
      botaoTexto="Enviar Sugestão"
    />
  );
}
